...
$$
\Delta^{v}_{D,V}= \int_0^3 \frac{x(-4)}{EI}\,dx =
\frac{-18}{EI}
$$
...
*Figure 16: FEM bending moment diagram vs. Analytical*
...
*Figure 17: FEM shear force diagram vs. Analytical*
